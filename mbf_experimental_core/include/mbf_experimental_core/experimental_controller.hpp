 ...
 * @brief This class takes the plan generated by the planner class and publish velocity commands that help the robot
 * traverse that plan. It has to function as the local planner, keeping track of obstacles and collisions and also as
 * the high level controller, generating velocity commands for the robot to follow.
 */
